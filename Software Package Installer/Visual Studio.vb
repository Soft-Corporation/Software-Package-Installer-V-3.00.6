...
Public Class Visual_Studio
    ...
    Private Sub Label6_Click(sender As Object, e As EventArgs) Handles Label6.Click
        ...
        Panel1.Hide()
        Panel7.Hide()
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_51600bf92a40453490892b3349634b90.zip"), TextBox1.Text)
    End Sub
