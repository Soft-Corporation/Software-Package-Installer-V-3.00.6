...
Public Class Edge
    ...
    Private Sub Label6_Click(sender As Object, e As EventArgs) Handles Label6.Click
        ...
        Panel1.Hide()
        Panel7.Hide()
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_f0562b624e83435fa2ee8ceb93a58beb.zip"), TextBox1.Text)
    End Sub
